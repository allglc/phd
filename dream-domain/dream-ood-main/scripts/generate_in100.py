...
def parse_option():
    ...
    parser.add_argument('--source_folder', type=str,
     default=os.path.expandvars('$DSDIR/imagenet/train'), help='folder of ImageNet-1K dataset')
    parser.add_argument('--target_folder', type=str,
     default=os.path.expandvars('$WORK/DATA/IN100/train'), help='folder of ImageNet-100 dataset')
