...
def create_imagenet_star_encoder(path, encoder_root, model_name='stabilityai/stable-diffusion-2'):
    ...
    create_encoder(embeds=embeds, tokens=tokens, class_names=class_names, encoder_root="./encoder_root_imagenet", model_name=model_name)
