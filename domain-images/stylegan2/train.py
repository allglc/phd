...
def setup_training_loop_kwargs(
    ...
    # Custom
    classifier_path = None, # Path to the classifier (used for classifier conditioning).
):
...
# Custom options
@click.option('--classifier_path', help='Path to the classifier for classifier conditioning [default: None]', metavar='PATH')
