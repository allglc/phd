...
DATASETS = {
	...
	'mnistCorrupt_encode': {
		'transforms': transforms_config.MNISTEncodeTransforms,
		'train_source_root': dataset_paths['mnistCorrupt_train'],
		'train_target_root': dataset_paths['mnistCorrupt_train'],
		'test_source_root': dataset_paths['mnistCorrupt_test'],
		'test_target_root': dataset_paths['mnistCorrupt_test'],
