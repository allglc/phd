...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Discriminator ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ #
    ...
    def sample_real_and_fake_latents(self, x):
        ...
        elif self.opts.stylegan2_implementation == 'nvidia':
            digits = torch.randint(0, self.net.decoder.c_dim, (self.opts.batch_size,), device=self.device)
            c = F.one_hot(digits, self.net.decoder.c_dim)
